...
namespace QuanLyBanHang.Forms
{
    public partial class frmLoaiSanPham : Form
    {
        ...
        bool xulyThem = false; //kiem tra co nhan nut them hay khong
        int id; // Lay ma loai san pham, dung cho sua va xoa
        ...
        {
            if (MessageBox.Show("Xac nhan xoa san pham? ", "Xoa", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                id = Convert.ToInt32(dataGridView1.CurrentRow.Cells["ID"].Value.ToString());
                LoaiSanPham lsp = context.LoaiSanPham.Find(id);
                if (lsp != null)
